...
define('HACL_HALOACL_VERSION', '1.7.0_0 [B68]');
...
if ($haclgUseFeaturesForGroupPermissions === true) {
	$haclgFeature['read']['systemfeatures'] = "writeapi|read";
	...
	$haclgFeature['technical']['systemfeatures'] = "purge|minoredit|nominornewtalk|noratelimit|ipblock-exempt|proxyunbannable|autopatrol|apihighlimits|suppressredirect|autoconfirmed|emailconfirmed";
