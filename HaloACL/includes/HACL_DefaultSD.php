...
//		}
	 ...
	 * 		<false>, if not
	 */
	private static function createDynamicSD(WikiPage $article, User $user) {
	 ...
	 * 		<false>, if not
	 */
	private static function createDynamicGroup(WikiPage $article, $user) {
	 ...
	 */
	private static function getMatchingDynamicSD(WikiPage $article, User $user) {
	 ...
	 */
	private static function getMatchingDynamicGroup(WikiPage $article, User $user) {
	 ...
	 * 
	 */
	private static function getCategories(WikiPage $article) {
